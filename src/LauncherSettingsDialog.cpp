...
LauncherSettingsDialog::LauncherSettingsDialog(wxWindow* parent, wxWindowID id,
  ...
  m_listData = new wxListCtrl(this, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                              wxLC_REPORT | wxLC_SINGLE_SEL);
  bSizerList->Add(m_listData, 1, wxALL | wxEXPAND, 5);

  m_cbCloseOnButton =
      new wxCheckBox(this, wxID_ANY, _("Close window on action"),
  ...
  m_bAdd = new wxButton(this, wxID_ANY, _("Add"), wxDefaultPosition,
                        wxDefaultSize, 0);
  bSizerButtons->Add(m_bAdd, 0, wxALL, 5);

  m_bEdit = new wxButton(this, wxID_ANY, _("Edit"), wxDefaultPosition,
                         wxDefaultSize, 0);
  bSizerButtons->Add(m_bEdit, 0, wxALL, 5);

  m_bRemove = new wxButton(this, wxID_ANY, _("Remove"), wxDefaultPosition,
                           wxDefaultSize, 0);
  ...
  m_listData->Connect(
      ...
      wxListEventHandler(LauncherSettingsDialog::OnItemDeselected), NULL, this);
  m_listData->Connect(
      wxEVT_COMMAND_LIST_ITEM_SELECTED,
      wxListEventHandler(LauncherSettingsDialog::OnItemSelected), NULL, this);
  m_bAdd->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                  wxCommandEventHandler(LauncherSettingsDialog::OnAddClick),
                  NULL, this);
  m_bEdit->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                   wxCommandEventHandler(LauncherSettingsDialog::OnEditClick),
                   NULL, this);
  m_bRemove->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(LauncherSettingsDialog::OnRemoveClick), NULL, this);
...
void LauncherSettingsDialog::OnAddClick(wxCommandEvent& event) {
  ...
  if (m_itemdlg->ShowModal() == wxID_OK) {
    long itemIndex = m_listData->InsertItem(m_listData->GetItemCount(),
                                            m_itemdlg->GetLabel());
...
void LauncherSettingsDialog::OnRemoveClick(wxCommandEvent& event) {
  if (wxMessageBox(_("Do you really want to remove this launcher action?"),
                   _("Really remove?"), wxYES_NO) == wxYES) {
    long itemIndex = -1;
    for (;;) {
      itemIndex = m_listData->GetNextItem(itemIndex, wxLIST_NEXT_ALL,
...
void LauncherSettingsDialog::SetItems(const wxArrayString& labels,
...
LauncherItemDialog::LauncherItemDialog(wxWindow* parent, wxWindowID id,
  ...
  m_stLabel = new wxStaticText(this, wxID_ANY, _("Label"), wxDefaultPosition,
                               wxDefaultSize, 0);
  m_stLabel->Wrap(-1);
  bSizerData->Add(m_stLabel, 0, wxALL, 5);

  m_tLabel = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition,
                            wxDefaultSize, 0);
  bSizerData->Add(m_tLabel, 0, wxALL | wxEXPAND, 5);

  m_stCommand = new wxStaticText(this, wxID_ANY, _("Command"),
                                 wxDefaultPosition, wxDefaultSize, 0);
  m_stCommand->Wrap(-1);
  bSizerData->Add(m_stCommand, 0, wxALL, 5);

  m_tCommand = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition,
                              wxDefaultSize, 0);
...
void LauncherItemDialog::SetValues(const wxString& label,
