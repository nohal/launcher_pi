...
int launcher_pi::Init() {
  ...
  m_leftclick_tool_id = InsertPlugInToolSVG(
      _T( "Launcher" ), _svg_launcher, _svg_launcher_rollover,
      _svg_launcher_toggled, wxITEM_CHECK, _("Launcher"), _T( "" ), nullptr,
  ...
  m_pLauncherDialog = new LauncherUIDialog(this, m_parent_window, wxID_ANY,
                                           _("Launcher"), pos, size);
